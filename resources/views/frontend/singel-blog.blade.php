                                ...
                                <div class="d-sm-flex align-items-top">
                                    ...
                                    <div class="flex-grow-1 ms-sm-3">
                                        ...
                                        <div class="my-3 badge bg-light">
                                            <a href="javascript: void(0);" class="text-primary"><i class="mdi mdi-reply"></i> Reply</a>
                                        </div>
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="card blog-modern-box overflow-hidden border-0">
                                                ...
                                                <div class="card-img-overlay">
                                                    <a href="blog-details.html" class="text-white">
                                                        <h5 class="card-title">Manage white space in responsive layouts ?</h5>
                                                    </a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card blog-modern-box overflow-hidden border-0">
                                                ...
                                                <div class="card-img-overlay">
                                                    <a href="blog-details.html" class="text-white">
                                                        <h5 class="card-title">A day in the of a professional fashion designer</h5>
                                                    </a>
                                                    <p class="card-text text-white-50"> <a href="blog-author.html" class="text-white-50">Rebecca Swartz</a> - 5 mins ago</p>
                                                </div>
                                            </div>
